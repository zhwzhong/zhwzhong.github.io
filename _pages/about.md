...
- The first neural architecture search method for guided depth map super-resolution.
</div>
</div>
...
- Propose a novel attention-based hierarchical multi-modal fusion (AHMF) network for guided depth map super-resolution.
</div>
</div>
